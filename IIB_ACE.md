...
- [ESQL](docs/esql.md)
  ...
  - [Propagation vs RETURN](docs/esql.md#propagation-vs-return)
    - [PROPAGATE](docs/esql.md#propagate)
      - [Key Behaviors:](docs/esql.md#key-behaviors)
    - [RETURN](#return)
      - [Key Behaviors:](docs/esql.md#key-behaviors-1)
    - [PROPAGATE vs RETURN TRUE vs RETURN FALSE in IBM ESQL](docs/esql.md#propagate-vs-return-true-vs-return-false-in-ibm-esql)
  ...
  - [Enabling Global Cache for multiple Integration Nodes (brokers)](docs/esql.md#enabling-global-cache-for-multiple-integration-nodes-brokers)
